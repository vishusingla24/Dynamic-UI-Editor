...
export default function PreviewUI({ settings }) {
    ...
    // alignment helper
    const alignStyle = { display: "flex", justifyContent: buttonAlign === "left" ? "flex-start" : buttonAlign === "center" ? "center" : "flex-end" };
    ...
    // layoutMode: two different designs
    return (
        <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
            {layoutMode === "desktop" ? (
                <div className="productCard" style={cardStyle}>
                    <div style={{ padding: 0 }}>
                        ...
                        <div className="cardContent" style={contentStyle}>
                            ...
                            <p style={{ color: "#6b7280", marginTop: 8 }}>Elegant furniture piece crafted with teak wood and modern minimal lines.</p>

                            {/* small gallery *//*}
                            <div style={{ marginTop: 16 }}>
                                <div className={`gallery ${galleryAlign}`} style={galleryStyle}>
                                    {images.map((src, idx) => (
                                        <img key={idx} src={src} alt={`g${idx}`} style={{ width: 96, height: 64, borderRadius: imageRadius, border: `${strokeWeight}px solid ${strokeColor}` }} />
                                    ))}
                                </div>
                            </div>
                ...
                <div className="productCard" style={{ ...cardStyle, display: "flex", flexDirection: "row", gap: 12 }}>
                    <div style={{ flex: "0 0 40%" }}>
                        <img src={images[0]} alt="thumb" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: `${imageRadius}px` }} />
                    </div>
                    <div style={{ flex: 1, padding: 16 }}>
                        <h3 style={{ margin: 0, fontSize: "1.1rem" }}>Modern Wooden Cabinet</h3>
                        <p style={{ color: "#6b7280", marginTop: 8 }}>Minimal cabinet for living room or hallway.</p>
